...
| 16 | **deMULTIplex2 / Stoeckius 2018** cell hashing *Genome Biol* | `multiseq` (**full local repro**) | **`bench score`: 7/13 analyses** (24/24 checks pass). On the bundled PBMC matrix: all 8 donor HTO groups from 15,113 cells, 83 % singlets, pool balance 0.79. The other 6 analyses need ground-truth labels that were never deposited | [`demultiplex2_stoeckius/`](demultiplex2_stoeckius/README.md) |
| 17 | **Rosenberg 2018** SPLiT-seq developing CNS *Science* | `splitseq` (**full local repro**) | **`bench score`: 7/12 analyses** (16/22 checks). 156,049-nucleus atlas parsed exactly; all 8 CNS lineages recovered | [`rosenberg2018_splitseq/`](rosenberg2018_splitseq/README.md) |
| 18 | **Ma 2020** SHARE-seq mouse skin *Cell* | `share` + shared `_scload` (**full local repro**) | **`bench score`: 7/10 analyses**. 34,774-cell skin set (exact); all 23 author cell types; Leiden AMI 0.63 on shallow SHARE-seq RNA | [`ma2020_shareseq/`](ma2020_shareseq/README.md) |
