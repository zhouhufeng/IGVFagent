# Skill validation coverage — igvfagent 0.2.9
...
| `network` | weinstock2024_cd4_crispr | 1 |

## Unvalidated

No benchmark in the suite executes these skills. That is a statement about coverage, not about correctness.

`advanced-variant`, `artifact`, `bench`, `calibrate`, `ccre`, `client`, `crispri`, `data`, `enhancer`, `explain`, `extauthor`, `frontpage`, `grn`, `kg`, `kg-mirror`, `multiseq`, `portal`, `portal-kg`, `proteomics`, `ref`, `rnaseq`, `sce2g-kg`, `se-targets`, `share`, `singlecell`, `skillcard`, `specialized`, `splitseq`, `starrseq`, `variant`, `variant-list`, `warehouse`
