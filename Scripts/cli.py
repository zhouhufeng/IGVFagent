...
SKILLS: "dict[str, tuple[str, str]]" = {
    ...
    "mct":              ("igvfagent.mct_analysis",
                          "snMCT-seq: RNA and methylation from the same "
                          "nuclei, analysed and cross-compared"),
    ...
    "sctransform":      ("igvfagent.sctransform_skill",
                          "SCTransform variance-stabilising normalisation "
                          "(regularised NB regression, Pearson residuals)"),
    ...
    "crispr-surf":      ("igvfagent.crispr_surf_skill",
                          "Deconvolve a CRISPR tiling screen into regulatory "
